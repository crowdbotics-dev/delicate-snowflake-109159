"""
Django settings for delicate_snowflake_109159 project.
...
ROOT_URLCONF = 'delicate_snowflake_109159.urls'
...
WSGI_APPLICATION = 'delicate_snowflake_109159.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_snowflake_109159 API",
    "DESCRIPTION": "API documentation for delicate_snowflake_109159 App",
    "VERSION": "v1",
}
